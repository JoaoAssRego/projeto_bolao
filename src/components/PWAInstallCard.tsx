      ...
      >
        ...
        <ul className="flex flex-col gap-2.5 mb-5">
          {BENEFITS.map(({ icon, text }) => (
            <li key={text} className="flex items-center gap-3 text-sm" style={{ color: 'var(--t2)' }}>
          ...
          >
            ...
            <ol className="flex flex-col gap-2">
              <li className="flex items-center gap-2">
                <span className="font-mono text-xs w-4" style={{ color: 'var(--t3)' }}>1.</span>
              ...
              <li className="flex items-center gap-2">
                <span className="font-mono text-xs w-4" style={{ color: 'var(--t3)' }}>2.</span>
                <span>
                  Selecione{' '}
                  <strong style={{ color: 'var(--t1)' }}>"Adicionar à Tela Inicial"</strong>
                </span>
              </li>
              <li className="flex items-center gap-2">
                <span className="font-mono text-xs w-4" style={{ color: 'var(--t3)' }}>3.</span>
                <span>
                  Toque em <strong style={{ color: 'var(--t1)' }}>"Adicionar"</strong>
                </span>
              </li>
            </ol>
          </div>
